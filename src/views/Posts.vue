<template>
    <div class="bg-white h-screen">
        ...
        <div>
            <div @touchstart="handleEventStart" @touchend="handleEventEnd" class="w-full z-10 bg-white shadow-navbar fixed bottom-0 transition-all duration-500" :class="{'h-32': !isOpen, 'h-4/5': isOpen}">
            </div>
            <div  class="w-full z-20 fixed bottom-0 h-20 bg-white  text-black flex flex-row justify-around items-center">
